      ...
      <div>
          <div>
             <MediaQuery query="(min-device-width: 768px)">
               <div>
                    <div id="logo"><img src="http://www.freelogoservices.com/api/main/images/1j+ojl1FOMkX9WypfBe43D6kjfCGqRFInRnJwXs1M3EMoAJtlSEuhvVu9v4z" alt="Girl in a jacket" width="250" height="135"/></div>
                 <Media autoPlay={true}>
                      <div className="media">
                        <div >
                          <Player poster="http://www.freelogoservices.com/api/main/images/1j+ojl1FOMkX9WypfBe43D6kjfCGqRFInRnJwXs1M3EMoAJtlSEuhvVu9v4z" autoPlay={true} loop={true}  width="1024" src="https://www.arla.com/globalassets/arla-global/milk/open-your-senses/smoothies/videos/open_your_senses_smoothies-split_deck-tropical_energiserconverted.mp4"/>
                        </div>
                      </div>
                    </Media></div>
             </MediaQuery>
